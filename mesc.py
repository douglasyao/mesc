...
Adapted from LD Score Regression software
...
import mesc.regressions as reg
import numpy as np
import pandas as pd
...
def ldscore(args, log):
    ...
    if args.g_l2:
        out_fname = args.out + '.' + file_suffix + '.gldscore'
    else:
...
parser.add_argument('--g-ld', default=None, type=str)
parser.add_argument('--g-ld-chr', default=None, type=str)
parser.add_argument('--g-l2', default=False, action='store_true')
parser.add_argument('--ref-ld-remove-annot', default=None, type=str)
parser.add_argument('--ref-ld-keep-annot', default=None, type=str)
parser.add_argument('--g-ld-remove-annot', default=None, type=str)
parser.add_argument('--g-ld-keep-annot', default=None, type=str)
parser.add_argument('--overlap-g-annot', default=False, action='store_true')
...
if __name__ == '__main__':
    ...
    if args.ref_ld_remove_annot == "None":
        args.ref_ld_remove_annot = None
    if args.ref_ld_keep_annot == "None":
        args.ref_ld_keep_annot = None
    if args.g_ld_remove_annot == "None":
        args.g_ld_remove_annot = None
    if args.g_ld_keep_annot == "None":
        args.g_ld_keep_annot = None
